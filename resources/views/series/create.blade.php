        ...
        <form method="POST" action="{{route('series.store')}}" class=" mt-5 bg-white col-8 mx-auto rounded-3 align-items-center bg-form border border-2 border-dark justify-content-center">
            ...
            <div class="row mx-auto col-11">
                <div class="col-6">
                    ...
                    <input type="text" class="form-control border-dark" name="titulo" value="{{ old('titulo')}}" maxlength="{{config('tam_numSerie')}}">
            ...
            <div class="row mb-0 justify-content-center">
                <div class="col-8">
                    ...
                    <textarea name="descripcion"  class="form-control border-dark" cols="10" rows="4">{{ old('descripcion')}}</textarea>
            ...
            <div class="row mx-auto col-11">
                <div class="col-6">
                    ...
                    <input type="number" name="estrellas" class="form-control border-dark" value="{{ old('estrellas')}}">
                ...
                <div class="col-6 d-flex justify-content-center">
                    <div class="col-6">
                        ...
                        <input type="date" class="form-control border-dark" name="fecha_estreno" value="{{ old('fecha_estreno')}}" maxlength="{{config('tam_fecha_estreno')}}">
            ...
            <div class="row mx-auto col-11">
                <div class="col-6">
                    ...
                    <input type="number" name="precio_alquiler" class="form-control border-dark" value="{{ old('precio_alquiler')}}">
